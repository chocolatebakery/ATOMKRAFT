...
OptionsMap::OptionsMap() {
  ...
  o["Book File"] = UCIOption("d:/eao.bin");
...
#ifdef FICS_VERSION
  o["OwnBook"] = UCIOption(true);	// always use the book with fics version
#else
  o["OwnBook"] = UCIOption(true);
#endif
  o["MultiPV"] = UCIOption(1, 1, 500);
  o["Skill Level"] = UCIOption(20, 0, 20);
  o["Emergency Move Horizon"] = UCIOption(20, 0, 50); // standard was 40
  o["Emergency Base Time"] = UCIOption(3000, 0, 30000);
  o["Emergency Move Time"] = UCIOption(70, 0, 5000);
  o["Minimum Thinking Time"] = UCIOption(0, 0, 5000);
  o["UCI_Chess960"] = UCIOption(false);
  o["UCI_AnalyseMode"] = UCIOption(false);
  o["EvalFile"] = UCIOption("atomic.nnue");
...
/// directly from the user by terminal window. So let's check the bounds anyway.
